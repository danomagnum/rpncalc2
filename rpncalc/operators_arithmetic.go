...
var OP_Pow = Operator{
	Name:        "^",
	Description: "Exponentiation.  Second to last item raised to the power of the last item. Result pushed onto the stack.",
	Operation: func(i *Interpreter) error {
		ss := i.SaveState()
		operand_0, err := i.Pop()
		if err != nil {
		...
		result := value_1.DecimalValue.Pow(value_0.DecimalValue)
		rval := NewValue(result)
		i.Push(rval)
